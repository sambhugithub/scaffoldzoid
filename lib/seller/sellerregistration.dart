...
class _SellerRegisterState extends State<SellerRegister> {
  ...
  Future registerdatasend()  async{
    var APIURL = "https://shorbazar.shop/shorbazarapp_api/assignment_sellerregistration.php";
    Map mapeddate ={
            ...
            child: Column(
              ...
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text("SELLER REGISTRATION",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 20),)
                  ],
                ),
                SizedBox(height: 10,),
