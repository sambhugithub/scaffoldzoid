...
class _BuyerLoginState extends State<BuyerLogin> {
  ...
  Future logindatasend()  async{
    var APIURL = "https://shorbazar.shop/shorbazarapp_api/assignment_buyerlogin.php";
    Map mapeddate ={
          ...
          child: Column(
            ...
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text("BUYER LOGIN",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 20),)
                ],
              ),
              SizedBox(height: 10,),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                          onTap: (){
                            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>BuyerRegister()));
                          },
